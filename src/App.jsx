...
function App() {
  ...
  return (
    ...
    <div className='m-auto my-4 rounded flex px-3 py-3 flex-col gap-5 bg-gray-100'>
      ...
      <p>I belong to Lakki Marwat. I currently completed Fsc in Darra Pezu in Jawad Medical Instituite. And nowaday i learning Mern Stack Developer Course in Peshawar in SMIT.</p>
